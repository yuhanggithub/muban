...
public class SwaggerConfig {
    ...
    public Docket buildDocket(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.yuhang.www.controller"))// controller路径。
    ...
    private ApiInfo buildApiInfo(){
        return new ApiInfoBuilder()
                ...
                .version("1.0.0")
                .termsOfServiceUrl("http://localhost/swagger/api-docs")
                .build();
